...
export const PLACES: Place[] = [
  ...
  p("Howick", "ZA", "KwaZulu-Natal", -29.488, 30.23, ["howick falls"]),
  p("Augrabies", "ZA", "Northern Cape", -28.591, 20.341, ["augrabies falls"]),
  p("Graskop", "ZA", "Mpumalanga", -24.931, 30.843, ["god's window", "gods window"]),
  p("Simon’s Town", "ZA", "Western Cape", -34.193, 18.435, ["simons town", "boulders"]),
  ...
  p("Naarden", "NL", "North Holland", 52.2953, 5.1622, ["vesting"]),
  p("Muiden", "NL", "North Holland", 52.334, 5.069, ["muiderslot"]),
