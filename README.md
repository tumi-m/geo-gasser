...
See `docs/providers.md`. Map tiles: OpenFreeMap (OSM-derived, no API key). Location plates: Wikimedia Commons (CC BY-SA) or labelled reconstructions. Round 4 is generated/procedural — never presented as a live photograph.
